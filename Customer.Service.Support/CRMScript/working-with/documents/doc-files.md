...
The physical document is tied to the [**NSDocumentEntity**](xref:crmscript_doc_properties) and stored in the document archive.
...
> [!TIP]
> To update only the document properties, [update the NSDocumentEntity](xref:crmscript_doc_properties).

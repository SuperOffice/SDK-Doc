...
```
    ...
    using SuperOffice.CRM.Lists;
        ...
        ArchiveRestrictionInfo contactId = new
ArchiveRestrictionInfo( "contactId", "equals", "51" );
...
ArchiveActivityRow.ColumnText,
                contactId );
        PrintMdoProvider(
ContactActivityArchiveProvider.ProviderName, provider );
...
SoLists ContactActivityArchiveProvider
